...
.bgcolor-skyblue {
 ...
 .image-aboutus-banner {
    background: linear-gradient(rgba(0,0,0,.2), rgba(0,0,0,.2)), url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQpQEWgDbizupD1q-WqrJtvhNpq3GVHL3aS2A&usqp=CAU");
